// Examples of private derivation
#include <iostream>
using namespace std;
...
{
    /*The public and protected both data memebrs of base class  becomes private data members of derived class while private derivation.
